          ...
          <div class="col-md-12">
            <div class="error-message"><?php if(isset($message)) echo $message; ?></div>
              ...
              <tbody>
                ...
                <tr>
                  <td>Item Options</td>
                  <td><input type="text" name="item_options" class="form-control mform-field" required id="inputName" placeholder="Enter Menu options seprated by comma"></td>
                </tr>

                <tr>
                  <td>Main Recipe Category</td>
                  <td>
                    <select name="menu_id" class="mform-field form-control" required>
                      <?php
                      if(isset($menu)){
